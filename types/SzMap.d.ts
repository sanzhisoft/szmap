...
declare module 'szmap' {
  ...
  export class CameraVideo extends Overlay {
    constructor(position: String | Array<Number> | JSON | Position, video: HTMLVideoElement, maskUrl?: String)
  ...
  export class PlaneVideo extends Overlay {
    constructor(position: String | Array<Number> | JSON | Position, video: HTMLVideoElement)
  ...
  export class Analysis {
    ...
    sightLine(startPosition: Position, endPosition: Position, excludes?: Array<any>, lerpNum?: Number): Analysis

    sightCircle(center: Position, radius: Number, excludes?: Array<any>, lerpNum?: Number): Analysis

    viewshed(position: Position, radius: Number, fov?: Number, aspectRatio?: Number, options?: JSON): Analysis
  }

  export class ModelManager {
    constructor(viewer: Viewer, models: Array<Model>, options: JSON)
  ...
  export class Measure {
    ...
    activate(type:MeasureType, options?:JSON):Measure

    deactivate():Measure
  }

  export function mixin(SzMap: any): void
